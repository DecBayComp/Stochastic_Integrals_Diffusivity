...
output_filename = 'Inferred_force_times_diffusivity_profile.pdf';
fD_PRECISION = 1e-7;
    ...
    for D_case_number = 1:max_D_case_number
        ...
        for l_ind = 1:lambda_count
            ...
            for bin = 1:x_bins_number
                % bin_fD_posterior_func (l_ind, bin, fD, t_step, kBT);
        ...
        %         optim_options = optimset('Display','iter', 'TolX', D_PRECISION);
            ...
            plot(x_bins_centers, inferred_MAP_fD, 'LineWidth', 2, 'color', default_color_order(l_ind, :))
