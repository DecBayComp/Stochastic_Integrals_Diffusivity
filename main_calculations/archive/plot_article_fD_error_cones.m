...
for l_ind = 1:lambda_count
    ...
    plot(difference, half_error, markers_list{1}, 'markers', marker_size);
    % Ito
    ...
    plot(difference, half_error, markers_list{3}, 'markers', marker_size);
    % Stratonovich
    ...
    ylim(y_lim_vec);
    xlabel('fD bias');
    ylabel('Half confidence interval');
