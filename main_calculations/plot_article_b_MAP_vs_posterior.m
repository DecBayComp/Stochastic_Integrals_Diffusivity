...
function plot_article_b_MAP_vs_posterior(data_struct, trials_data, fig_count, bl_save_figures)
...
[selected_bins_indices, selected_bins_centers] = get_selected_bins_indices(data_struct, selected_x_over_L);
