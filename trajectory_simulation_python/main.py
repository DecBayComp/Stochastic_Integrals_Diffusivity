...
def main(arg_str):
    """
    This is the new main file for simulations with ksi = alpha/D' as the main parameter.
    There is also an orthogonal total force if necessary.
    Use D_case = 2.
    ...
    arg_parser.add_argument('-o', '--orthogonal-force', dest='bl_orthogonal_force',
                            action='store_true', default=False, help='Add a fixed orthogonal total force component. Default: no orthogonal component')
    arg_parser.set_defaults(bl_orthogonal_force=False)
